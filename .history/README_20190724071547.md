...
* `cd hellong`
* `npm run eject`
* To change the build path to point to `force-app/main/default/staticresources`, open `force-app/ngapp/hellong/angular.json` and update `architect > builder > options > "outputPath"` to `../../main/default/staticresources/hellong`
